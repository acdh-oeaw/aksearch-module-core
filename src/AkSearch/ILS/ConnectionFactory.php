<?php
/**
 * AK: Extending ILS connection factory
 *
 * PHP version 7
 *
...
class ConnectionFactory extends \VuFind\ILS\ConnectionFactory
{
    ...
    public function __invoke(ContainerInterface $container, $requestedName,
        ...
        $catalog = new $requestedName(
            ...
            // AK: Provide the PluginManager with factory and alias pointing to custom Alma ILS driver:
            $container->get('AkSearch\ILS\Driver\PluginManager'),
