 ...
 * @link     https://vufind.org/wiki/development:plugins:view_helpers Wiki
 */
class WarningsFactory implements FactoryInterface
{
    /**
     * AK: Create an object
     *
    ...
    public function __invoke(ContainerInterface $container, $requestedName,
        ...
        $warningsConfig = isset($mainConfig->Warnings)
            ? $mainConfig->Warnings->toArray()
            : [];
        return new $requestedName($warningsConfig);
    }
}
